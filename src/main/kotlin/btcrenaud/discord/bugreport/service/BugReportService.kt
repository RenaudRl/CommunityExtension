...
import btcrenaud.discord.bugreport.data.BooleanInput
import btcrenaud.discord.bugreport.data.BugReport
import btcrenaud.discord.bugreport.data.BugReportCategory
import btcrenaud.discord.bugreport.data.BugReportInput
import btcrenaud.discord.bugreport.data.LocationSnapshot
import btcrenaud.discord.bugreport.data.TextInput
import btcrenaud.discord.bugreport.data.asHumanReadable
...
class BugReportService(
    ...
    private fun submit(
        ...
        // The service judges on its own whether the destination can be delivered to: testing
        // it here as well would keep two definitions of "enabled" that end up diverging.
